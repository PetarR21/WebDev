...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, equals the total likes of the list', () => {
...
describe('most blogs', () => {
  ...
  test('when list has multiple blogs, equals auhtor with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has multiple blogs, equals auhtor with most likes', () => {
